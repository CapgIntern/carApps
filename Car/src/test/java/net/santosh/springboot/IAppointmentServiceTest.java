...
//		Appointment appointment = new Appointment("3120", 123L, "kavoor", "Open", preferredDate, preferredTime);
...
//				.of(new Appointment("3120", 123L, "kavoor", "Open", preferredDate, preferredTime));
...
//	}
	...
	public void getAllAppointmentsTest() {
		...
		Appointment appointment_values_1 = new Appointment("3120", 123L, "kavoor", "Open", preferredDate_1, preferredTime_1);
		LocalDate preferredDate_2 = LocalDate.of(2007, 12, 03);
		LocalTime preferredTime_2 = LocalTime.of(8, 9);
		Appointment appointment_values_2 = new Appointment("3120", 312L, "chennai", "Open", preferredDate_2, preferredTime_2);
		LocalDate preferredDate_3 = LocalDate.of(2007, 12, 03);
		LocalTime preferredTime_3 = LocalTime.of(8, 9);
		Appointment appointment_values_3 = new Appointment("3120", 456L, "mumbai", "Open", preferredDate_3, preferredTime_3);
...
//		LocalDate preferredDate_2 = LocalDate.of(2007, 12, 03);
//		LocalTime preferredTime_2 = LocalTime.of(8, 9);
//		Appointment new_appointment_values = new Appointment("3120", 123L, "mumbai", "Open", preferredDate_2, preferredTime_2);
//
